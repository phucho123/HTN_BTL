...
const Switch = React.memo(function ({ feed }) {
    ...
    return (
        <div className="form-check form-switch" style={{ width: "100%", height: "100%", margin: 10, display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
            <input className="form-check-input" type="checkbox" style={{ width: 200, height: 80, cursor: "pointer" }} onClick={handleToogle} id={feed} />
            {/* {
